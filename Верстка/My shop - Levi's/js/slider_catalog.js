...
var multiItemSlider = (function () {
    ...
    return function (selector, config) {
        var
            ...
            _sliderWrapper = _mainElement.querySelector('.slider__catalog__wrapper'),
            _sliderItems = _mainElement.querySelectorAll('.slider__catalog__item'),
        ...
        var _addIndicators = function () {
            ...
            sliderIndicators.classList.add('slider__catalog__indicators');
            ...
            _indicatorItems = _mainElement.querySelectorAll('.slider__catalog__indicators > li')
        }
...
var slider = multiItemSlider('.slider__catalog', {
    isCycling: true
});
